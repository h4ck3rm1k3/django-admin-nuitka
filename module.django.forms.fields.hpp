#ifndef __django__forms__fields_H__
#define __django__forms__fields_H__
...
extern PyObject *_module_django__forms__fields;
extern PyDictObject *_moduledict_django__forms__fields;

class PyObjectGlobalVariable_django__forms__fields
{
    public:
        explicit PyObjectGlobalVariable_django__forms__fields( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__forms__fields, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__forms__fields, (PyObject *)*this->var_name );
