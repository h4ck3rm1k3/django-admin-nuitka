#ifndef __django__conf__global_settings_H__
#define __django__conf__global_settings_H__
...
extern PyObject *_module_django__conf__global_settings;
extern PyDictObject *_moduledict_django__conf__global_settings;

class PyObjectGlobalVariable_django__conf__global_settings
{
    public:
        explicit PyObjectGlobalVariable_django__conf__global_settings( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__conf__global_settings, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__conf__global_settings, (PyObject *)*this->var_name );
