#ifndef __django__core__files__storage_H__
#define __django__core__files__storage_H__
...
extern PyObject *_module_django__core__files__storage;
extern PyDictObject *_moduledict_django__core__files__storage;

class PyObjectGlobalVariable_django__core__files__storage
{
    public:
        explicit PyObjectGlobalVariable_django__core__files__storage( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__core__files__storage, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__core__files__storage, (PyObject *)*this->var_name );
