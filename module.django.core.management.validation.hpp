#ifndef __django__core__management__validation_H__
#define __django__core__management__validation_H__
...
extern PyObject *_module_django__core__management__validation;
extern PyDictObject *_moduledict_django__core__management__validation;

class PyObjectGlobalVariable_django__core__management__validation
{
    public:
        explicit PyObjectGlobalVariable_django__core__management__validation( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__core__management__validation, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__core__management__validation, (PyObject *)*this->var_name );
