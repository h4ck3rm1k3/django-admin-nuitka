#ifndef __django__db__models__sql__where_H__
#define __django__db__models__sql__where_H__


#include <nuitka/helpers.hpp>

MOD_INIT_DECL( django__db__models__sql__where );

extern PyObject *_module_django__db__models__sql__where;
extern PyDictObject *_moduledict_django__db__models__sql__where;

class PyObjectGlobalVariable_django__db__models__sql__where
{
    public:
        explicit PyObjectGlobalVariable_django__db__models__sql__where( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__db__models__sql__where, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__db__models__sql__where, (PyObject *)*this->var_name );
