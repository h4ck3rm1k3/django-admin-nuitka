#ifndef __django__db__models__sql__constants_H__
#define __django__db__models__sql__constants_H__
...
extern PyObject *_module_django__db__models__sql__constants;
extern PyDictObject *_moduledict_django__db__models__sql__constants;

class PyObjectGlobalVariable_django__db__models__sql__constants
{
    public:
        explicit PyObjectGlobalVariable_django__db__models__sql__constants( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__db__models__sql__constants, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__db__models__sql__constants, (PyObject *)*this->var_name );
