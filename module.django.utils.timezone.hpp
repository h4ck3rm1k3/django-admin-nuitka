#ifndef __django__utils__timezone_H__
#define __django__utils__timezone_H__
...
extern PyObject *_module_django__utils__timezone;
extern PyDictObject *_moduledict_django__utils__timezone;

class PyObjectGlobalVariable_django__utils__timezone
{
    public:
        explicit PyObjectGlobalVariable_django__utils__timezone( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__utils__timezone, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__utils__timezone, (PyObject *)*this->var_name );
