#ifndef __django__conf__urls_H__
#define __django__conf__urls_H__
...
extern PyObject *_module_django__conf__urls;
extern PyDictObject *_moduledict_django__conf__urls;

class PyObjectGlobalVariable_django__conf__urls
{
    public:
        explicit PyObjectGlobalVariable_django__conf__urls( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__conf__urls, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__conf__urls, (PyObject *)*this->var_name );
