#ifndef __django__dispatch__dispatcher_H__
#define __django__dispatch__dispatcher_H__
...
extern PyObject *_module_django__dispatch__dispatcher;
extern PyDictObject *_moduledict_django__dispatch__dispatcher;

class PyObjectGlobalVariable_django__dispatch__dispatcher
{
    public:
        explicit PyObjectGlobalVariable_django__dispatch__dispatcher( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__dispatch__dispatcher, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__dispatch__dispatcher, (PyObject *)*this->var_name );
