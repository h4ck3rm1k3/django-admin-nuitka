#ifndef __django__core__mail_H__
#define __django__core__mail_H__
...
extern PyObject *_module_django__core__mail;
extern PyDictObject *_moduledict_django__core__mail;

class PyObjectGlobalVariable_django__core__mail
{
    public:
        explicit PyObjectGlobalVariable_django__core__mail( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__core__mail, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__core__mail, (PyObject *)*this->var_name );
