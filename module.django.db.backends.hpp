#ifndef __django__db__backends_H__
#define __django__db__backends_H__
...
extern PyObject *_module_django__db__backends;
extern PyDictObject *_moduledict_django__db__backends;

class PyObjectGlobalVariable_django__db__backends
{
    public:
        explicit PyObjectGlobalVariable_django__db__backends( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__db__backends, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__db__backends, (PyObject *)*this->var_name );
