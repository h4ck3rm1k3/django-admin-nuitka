#ifndef __django__utils__daemonize_H__
#define __django__utils__daemonize_H__
...
extern PyObject *_module_django__utils__daemonize;
extern PyDictObject *_moduledict_django__utils__daemonize;

class PyObjectGlobalVariable_django__utils__daemonize
{
    public:
        explicit PyObjectGlobalVariable_django__utils__daemonize( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__utils__daemonize, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__utils__daemonize, (PyObject *)*this->var_name );
