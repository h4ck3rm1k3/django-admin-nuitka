#ifndef __django__db__models__related_H__
#define __django__db__models__related_H__
...
extern PyObject *_module_django__db__models__related;
extern PyDictObject *_moduledict_django__db__models__related;

class PyObjectGlobalVariable_django__db__models__related
{
    public:
        explicit PyObjectGlobalVariable_django__db__models__related( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__db__models__related, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__db__models__related, (PyObject *)*this->var_name );
