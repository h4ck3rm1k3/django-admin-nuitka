#ifndef __django__utils__module_loading_H__
#define __django__utils__module_loading_H__
...
extern PyObject *_module_django__utils__module_loading;
extern PyDictObject *_moduledict_django__utils__module_loading;

class PyObjectGlobalVariable_django__utils__module_loading
{
    public:
        explicit PyObjectGlobalVariable_django__utils__module_loading( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__utils__module_loading, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__utils__module_loading, (PyObject *)*this->var_name );
