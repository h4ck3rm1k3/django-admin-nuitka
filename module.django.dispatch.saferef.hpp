#ifndef __django__dispatch__saferef_H__
#define __django__dispatch__saferef_H__
...
extern PyObject *_module_django__dispatch__saferef;
extern PyDictObject *_moduledict_django__dispatch__saferef;

class PyObjectGlobalVariable_django__dispatch__saferef
{
    public:
        explicit PyObjectGlobalVariable_django__dispatch__saferef( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__dispatch__saferef, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__dispatch__saferef, (PyObject *)*this->var_name );
