#ifndef __django__utils__timesince_H__
#define __django__utils__timesince_H__
...
extern PyObject *_module_django__utils__timesince;
extern PyDictObject *_moduledict_django__utils__timesince;

class PyObjectGlobalVariable_django__utils__timesince
{
    public:
        explicit PyObjectGlobalVariable_django__utils__timesince( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__utils__timesince, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__utils__timesince, (PyObject *)*this->var_name );
