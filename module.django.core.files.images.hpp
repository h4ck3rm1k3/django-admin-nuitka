#ifndef __django__core__files__images_H__
#define __django__core__files__images_H__
...
extern PyObject *_module_django__core__files__images;
extern PyDictObject *_moduledict_django__core__files__images;

class PyObjectGlobalVariable_django__core__files__images
{
    public:
        explicit PyObjectGlobalVariable_django__core__files__images( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__core__files__images, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__core__files__images, (PyObject *)*this->var_name );
