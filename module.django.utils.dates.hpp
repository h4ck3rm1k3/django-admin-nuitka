#ifndef __django__utils__dates_H__
#define __django__utils__dates_H__
...
extern PyObject *_module_django__utils__dates;
extern PyDictObject *_moduledict_django__utils__dates;

class PyObjectGlobalVariable_django__utils__dates
{
    public:
        explicit PyObjectGlobalVariable_django__utils__dates( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__utils__dates, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__utils__dates, (PyObject *)*this->var_name );
