#ifndef __django__http__request_H__
#define __django__http__request_H__
...
extern PyObject *_module_django__http__request;
extern PyDictObject *_moduledict_django__http__request;

class PyObjectGlobalVariable_django__http__request
{
    public:
        explicit PyObjectGlobalVariable_django__http__request( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__http__request, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__http__request, (PyObject *)*this->var_name );
