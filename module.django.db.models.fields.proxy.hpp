#ifndef __django__db__models__fields__proxy_H__
#define __django__db__models__fields__proxy_H__
...
extern PyObject *_module_django__db__models__fields__proxy;
extern PyDictObject *_moduledict_django__db__models__fields__proxy;

class PyObjectGlobalVariable_django__db__models__fields__proxy
{
    public:
        explicit PyObjectGlobalVariable_django__db__models__fields__proxy( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__db__models__fields__proxy, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__db__models__fields__proxy, (PyObject *)*this->var_name );
