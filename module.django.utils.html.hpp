#ifndef __django__utils__html_H__
#define __django__utils__html_H__
...
extern PyObject *_module_django__utils__html;
extern PyDictObject *_moduledict_django__utils__html;

class PyObjectGlobalVariable_django__utils__html
{
    public:
        explicit PyObjectGlobalVariable_django__utils__html( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__utils__html, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__utils__html, (PyObject *)*this->var_name );
