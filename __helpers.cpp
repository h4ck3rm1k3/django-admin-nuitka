...
PyObject *CALL_FUNCTION_WITH_ARGS( PyObject *called, PyObject *arg0 )
{
    assertObject( called );

    // Check if arguments are valid objects in debug mode.
#ifndef __NUITKA_NO_ASSERT__
    PyObject *args_for_test[] = { arg0 };
    ...
    return CALL_FUNCTION(
        called,
        PyObjectTemporary( MAKE_TUPLE1( arg0 ) ).asObject(),
        NULL
    );
}

PyObject *CALL_FUNCTION_WITH_ARGS( PyObject *called, PyObject *arg0, PyObject *arg1 )
{
    assertObject( called );

    // Check if arguments are valid objects in debug mode.
#ifndef __NUITKA_NO_ASSERT__
    PyObject *args_for_test[] = { arg0, arg1 };
    ...
    return CALL_FUNCTION(
        called,
        PyObjectTemporary( MAKE_TUPLE2( arg0, arg1 ) ).asObject(),
        NULL
    );
}

PyObject *CALL_FUNCTION_WITH_ARGS( PyObject *called, PyObject *arg0, PyObject *arg1, PyObject *arg2 )
{
    assertObject( called );

    // Check if arguments are valid objects in debug mode.
#ifndef __NUITKA_NO_ASSERT__
    PyObject *args_for_test[] = { arg0, arg1, arg2 };
    ...
    return CALL_FUNCTION(
        called,
        PyObjectTemporary( MAKE_TUPLE3( arg0, arg1, arg2 ) ).asObject(),
        NULL
    );
}

PyObject *CALL_FUNCTION_WITH_ARGS( PyObject *called, PyObject *arg0, PyObject *arg1, PyObject *arg2, PyObject *arg3 )
{
    assertObject( called );

    // Check if arguments are valid objects in debug mode.
#ifndef __NUITKA_NO_ASSERT__
    PyObject *args_for_test[] = { arg0, arg1, arg2, arg3 };
    ...
    if ( Nuitka_Function_Check( called ) )
    {
        ...
        PyObject *args[] = { arg0, arg1, arg2, arg3 };
    ...
    return CALL_FUNCTION(
        called,
        PyObjectTemporary( MAKE_TUPLE4( arg0, arg1, arg2, arg3 ) ).asObject(),
        NULL
    );
}

PyObject *CALL_FUNCTION_WITH_ARGS( PyObject *called, PyObject *arg0, PyObject *arg1, PyObject *arg2, PyObject *arg3, PyObject *arg4 )
{
    assertObject( called );

    // Check if arguments are valid objects in debug mode.
#ifndef __NUITKA_NO_ASSERT__
    PyObject *args_for_test[] = { arg0, arg1, arg2, arg3, arg4 };
    ...
    if ( Nuitka_Function_Check( called ) )
    {
        ...
        PyObject *args[] = { arg0, arg1, arg2, arg3, arg4 };
    ...
    return CALL_FUNCTION(
        called,
        PyObjectTemporary( MAKE_TUPLE5( arg0, arg1, arg2, arg3, arg4 ) ).asObject(),
        NULL
    );
}
