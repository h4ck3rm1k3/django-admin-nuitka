#ifndef __django__utils__six_H__
#define __django__utils__six_H__


#include <nuitka/helpers.hpp>

MOD_INIT_DECL( django__utils__six );

extern PyObject *_module_django__utils__six;
extern PyDictObject *_moduledict_django__utils__six;

class PyObjectGlobalVariable_django__utils__six
{
    public:
        explicit PyObjectGlobalVariable_django__utils__six( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__utils__six, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__utils__six, (PyObject *)*this->var_name );
