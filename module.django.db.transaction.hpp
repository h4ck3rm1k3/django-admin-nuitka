#ifndef __django__db__transaction_H__
#define __django__db__transaction_H__
...
extern PyObject *_module_django__db__transaction;
extern PyDictObject *_moduledict_django__db__transaction;

class PyObjectGlobalVariable_django__db__transaction
{
    public:
        explicit PyObjectGlobalVariable_django__db__transaction( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__db__transaction, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__db__transaction, (PyObject *)*this->var_name );
