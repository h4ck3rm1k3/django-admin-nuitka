#ifndef __django__forms__models_H__
#define __django__forms__models_H__
...
extern PyObject *_module_django__forms__models;
extern PyDictObject *_moduledict_django__forms__models;

class PyObjectGlobalVariable_django__forms__models
{
    public:
        explicit PyObjectGlobalVariable_django__forms__models( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__forms__models, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__forms__models, (PyObject *)*this->var_name );
