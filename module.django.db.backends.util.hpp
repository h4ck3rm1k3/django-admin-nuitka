#ifndef __django__db__backends__util_H__
#define __django__db__backends__util_H__
...
extern PyObject *_module_django__db__backends__util;
extern PyDictObject *_moduledict_django__db__backends__util;

class PyObjectGlobalVariable_django__db__backends__util
{
    public:
        explicit PyObjectGlobalVariable_django__db__backends__util( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__db__backends__util, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__db__backends__util, (PyObject *)*this->var_name );
