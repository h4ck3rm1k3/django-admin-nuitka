#ifndef __django__core__servers__basehttp_H__
#define __django__core__servers__basehttp_H__
...
extern PyObject *_module_django__core__servers__basehttp;
extern PyDictObject *_moduledict_django__core__servers__basehttp;

class PyObjectGlobalVariable_django__core__servers__basehttp
{
    public:
        explicit PyObjectGlobalVariable_django__core__servers__basehttp( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__core__servers__basehttp, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__core__servers__basehttp, (PyObject *)*this->var_name );
