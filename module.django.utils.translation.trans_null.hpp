#ifndef __django__utils__translation__trans_null_H__
#define __django__utils__translation__trans_null_H__
...
extern PyObject *_module_django__utils__translation__trans_null;
extern PyDictObject *_moduledict_django__utils__translation__trans_null;

class PyObjectGlobalVariable_django__utils__translation__trans_null
{
    public:
        explicit PyObjectGlobalVariable_django__utils__translation__trans_null( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__utils__translation__trans_null, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__utils__translation__trans_null, (PyObject *)*this->var_name );
