#ifndef __django__views_H__
#define __django__views_H__
...
extern PyObject *_module_django__views;
extern PyDictObject *_moduledict_django__views;

class PyObjectGlobalVariable_django__views
{
    public:
        explicit PyObjectGlobalVariable_django__views( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__views, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__views, (PyObject *)*this->var_name );
