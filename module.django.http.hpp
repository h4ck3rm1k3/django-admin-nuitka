#ifndef __django__http_H__
#define __django__http_H__
...
extern PyObject *_module_django__http;
extern PyDictObject *_moduledict_django__http;

class PyObjectGlobalVariable_django__http
{
    public:
        explicit PyObjectGlobalVariable_django__http( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__http, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__http, (PyObject *)*this->var_name );
