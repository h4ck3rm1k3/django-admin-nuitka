#ifndef __django__utils__translation_H__
#define __django__utils__translation_H__


#include <nuitka/helpers.hpp>

MOD_INIT_DECL( django__utils__translation );

extern PyObject *_module_django__utils__translation;
extern PyDictObject *_moduledict_django__utils__translation;

class PyObjectGlobalVariable_django__utils__translation
{
    public:
        explicit PyObjectGlobalVariable_django__utils__translation( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__utils__translation, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__utils__translation, (PyObject *)*this->var_name );
