#ifndef __django__db__models__sql__query_H__
#define __django__db__models__sql__query_H__
...
extern PyObject *_module_django__db__models__sql__query;
extern PyDictObject *_moduledict_django__db__models__sql__query;

class PyObjectGlobalVariable_django__db__models__sql__query
{
    public:
        explicit PyObjectGlobalVariable_django__db__models__sql__query( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__db__models__sql__query, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__db__models__sql__query, (PyObject *)*this->var_name );
