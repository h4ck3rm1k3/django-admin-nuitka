#ifndef __django__core__handlers__wsgi_H__
#define __django__core__handlers__wsgi_H__


#include <nuitka/helpers.hpp>

MOD_INIT_DECL( django__core__handlers__wsgi );

extern PyObject *_module_django__core__handlers__wsgi;
extern PyDictObject *_moduledict_django__core__handlers__wsgi;

class PyObjectGlobalVariable_django__core__handlers__wsgi
{
    public:
        explicit PyObjectGlobalVariable_django__core__handlers__wsgi( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__core__handlers__wsgi, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__core__handlers__wsgi, (PyObject *)*this->var_name );
