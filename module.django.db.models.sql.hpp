#ifndef __django__db__models__sql_H__
#define __django__db__models__sql_H__
...
extern PyObject *_module_django__db__models__sql;
extern PyDictObject *_moduledict_django__db__models__sql;

class PyObjectGlobalVariable_django__db__models__sql
{
    public:
        explicit PyObjectGlobalVariable_django__db__models__sql( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__db__models__sql, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__db__models__sql, (PyObject *)*this->var_name );
