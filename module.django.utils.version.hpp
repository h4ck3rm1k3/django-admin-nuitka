#ifndef __django__utils__version_H__
#define __django__utils__version_H__
...
extern PyObject *_module_django__utils__version;
extern PyDictObject *_moduledict_django__utils__version;

class PyObjectGlobalVariable_django__utils__version
{
    public:
        explicit PyObjectGlobalVariable_django__utils__version( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__utils__version, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__utils__version, (PyObject *)*this->var_name );
