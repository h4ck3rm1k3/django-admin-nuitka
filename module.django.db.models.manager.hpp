#ifndef __django__db__models__manager_H__
#define __django__db__models__manager_H__
...
extern PyObject *_module_django__db__models__manager;
extern PyDictObject *_moduledict_django__db__models__manager;

class PyObjectGlobalVariable_django__db__models__manager
{
    public:
        explicit PyObjectGlobalVariable_django__db__models__manager( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__db__models__manager, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__db__models__manager, (PyObject *)*this->var_name );
