#ifndef __django__utils__crypto_H__
#define __django__utils__crypto_H__
...
extern PyObject *_module_django__utils__crypto;
extern PyDictObject *_moduledict_django__utils__crypto;

class PyObjectGlobalVariable_django__utils__crypto
{
    public:
        explicit PyObjectGlobalVariable_django__utils__crypto( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__utils__crypto, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__utils__crypto, (PyObject *)*this->var_name );
