#ifndef __django__utils__datetime_safe_H__
#define __django__utils__datetime_safe_H__
...
extern PyObject *_module_django__utils__datetime_safe;
extern PyDictObject *_moduledict_django__utils__datetime_safe;

class PyObjectGlobalVariable_django__utils__datetime_safe
{
    public:
        explicit PyObjectGlobalVariable_django__utils__datetime_safe( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__utils__datetime_safe, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__utils__datetime_safe, (PyObject *)*this->var_name );
