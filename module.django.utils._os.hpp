#ifndef __django__utils___os_H__
#define __django__utils___os_H__
...
extern PyObject *_module_django__utils___os;
extern PyDictObject *_moduledict_django__utils___os;

class PyObjectGlobalVariable_django__utils___os
{
    public:
        explicit PyObjectGlobalVariable_django__utils___os( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__utils___os, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__utils___os, (PyObject *)*this->var_name );
