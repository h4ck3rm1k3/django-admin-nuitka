#ifndef __django__core__files__uploadhandler_H__
#define __django__core__files__uploadhandler_H__
...
extern PyObject *_module_django__core__files__uploadhandler;
extern PyDictObject *_moduledict_django__core__files__uploadhandler;

class PyObjectGlobalVariable_django__core__files__uploadhandler
{
    public:
        explicit PyObjectGlobalVariable_django__core__files__uploadhandler( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__core__files__uploadhandler, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__core__files__uploadhandler, (PyObject *)*this->var_name );
