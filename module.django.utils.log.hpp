#ifndef __django__utils__log_H__
#define __django__utils__log_H__
...
extern PyObject *_module_django__utils__log;
extern PyDictObject *_moduledict_django__utils__log;

class PyObjectGlobalVariable_django__utils__log
{
    public:
        explicit PyObjectGlobalVariable_django__utils__log( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__utils__log, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__utils__log, (PyObject *)*this->var_name );
