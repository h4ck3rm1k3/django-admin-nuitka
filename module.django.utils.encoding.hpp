#ifndef __django__utils__encoding_H__
#define __django__utils__encoding_H__


#include <nuitka/helpers.hpp>

MOD_INIT_DECL( django__utils__encoding );

extern PyObject *_module_django__utils__encoding;
extern PyDictObject *_moduledict_django__utils__encoding;

class PyObjectGlobalVariable_django__utils__encoding
{
    public:
        explicit PyObjectGlobalVariable_django__utils__encoding( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__utils__encoding, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__utils__encoding, (PyObject *)*this->var_name );
