#ifndef __django__dispatch_H__
#define __django__dispatch_H__
...
extern PyObject *_module_django__dispatch;
extern PyDictObject *_moduledict_django__dispatch;

class PyObjectGlobalVariable_django__dispatch
{
    public:
        explicit PyObjectGlobalVariable_django__dispatch( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__dispatch, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__dispatch, (PyObject *)*this->var_name );
