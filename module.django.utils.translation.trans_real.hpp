#ifndef __django__utils__translation__trans_real_H__
#define __django__utils__translation__trans_real_H__
...
extern PyObject *_module_django__utils__translation__trans_real;
extern PyDictObject *_moduledict_django__utils__translation__trans_real;

class PyObjectGlobalVariable_django__utils__translation__trans_real
{
    public:
        explicit PyObjectGlobalVariable_django__utils__translation__trans_real( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__utils__translation__trans_real, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__utils__translation__trans_real, (PyObject *)*this->var_name );
