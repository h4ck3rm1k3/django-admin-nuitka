#ifndef __django__db__models__deletion_H__
#define __django__db__models__deletion_H__


#include <nuitka/helpers.hpp>

MOD_INIT_DECL( django__db__models__deletion );

extern PyObject *_module_django__db__models__deletion;
extern PyDictObject *_moduledict_django__db__models__deletion;

class PyObjectGlobalVariable_django__db__models__deletion
{
    public:
        explicit PyObjectGlobalVariable_django__db__models__deletion( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__db__models__deletion, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__db__models__deletion, (PyObject *)*this->var_name );
