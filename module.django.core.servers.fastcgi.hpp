#ifndef __django__core__servers__fastcgi_H__
#define __django__core__servers__fastcgi_H__
...
extern PyObject *_module_django__core__servers__fastcgi;
extern PyDictObject *_moduledict_django__core__servers__fastcgi;

class PyObjectGlobalVariable_django__core__servers__fastcgi
{
    public:
        explicit PyObjectGlobalVariable_django__core__servers__fastcgi( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__core__servers__fastcgi, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__core__servers__fastcgi, (PyObject *)*this->var_name );
