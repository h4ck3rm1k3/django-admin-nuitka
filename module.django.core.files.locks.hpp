#ifndef __django__core__files__locks_H__
#define __django__core__files__locks_H__
...
extern PyObject *_module_django__core__files__locks;
extern PyDictObject *_moduledict_django__core__files__locks;

class PyObjectGlobalVariable_django__core__files__locks
{
    public:
        explicit PyObjectGlobalVariable_django__core__files__locks( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__core__files__locks, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__core__files__locks, (PyObject *)*this->var_name );
