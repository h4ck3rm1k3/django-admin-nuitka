#ifndef __django__db_H__
#define __django__db_H__
...
extern PyObject *_module_django__db;
extern PyDictObject *_moduledict_django__db;

class PyObjectGlobalVariable_django__db
{
    public:
        explicit PyObjectGlobalVariable_django__db( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__db, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__db, (PyObject *)*this->var_name );
