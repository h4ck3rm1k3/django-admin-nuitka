#ifndef __django__db__models__loading_H__
#define __django__db__models__loading_H__
...
extern PyObject *_module_django__db__models__loading;
extern PyDictObject *_moduledict_django__db__models__loading;

class PyObjectGlobalVariable_django__db__models__loading
{
    public:
        explicit PyObjectGlobalVariable_django__db__models__loading( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__db__models__loading, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__db__models__loading, (PyObject *)*this->var_name );
