#ifndef __django__utils__baseconv_H__
#define __django__utils__baseconv_H__
...
extern PyObject *_module_django__utils__baseconv;
extern PyDictObject *_moduledict_django__utils__baseconv;

class PyObjectGlobalVariable_django__utils__baseconv
{
    public:
        explicit PyObjectGlobalVariable_django__utils__baseconv( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__utils__baseconv, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__utils__baseconv, (PyObject *)*this->var_name );
