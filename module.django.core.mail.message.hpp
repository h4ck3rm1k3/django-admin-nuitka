#ifndef __django__core__mail__message_H__
#define __django__core__mail__message_H__
...
extern PyObject *_module_django__core__mail__message;
extern PyDictObject *_moduledict_django__core__mail__message;

class PyObjectGlobalVariable_django__core__mail__message
{
    public:
        explicit PyObjectGlobalVariable_django__core__mail__message( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__core__mail__message, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__core__mail__message, (PyObject *)*this->var_name );
