#ifndef __django__utils__dateparse_H__
#define __django__utils__dateparse_H__
...
extern PyObject *_module_django__utils__dateparse;
extern PyDictObject *_moduledict_django__utils__dateparse;

class PyObjectGlobalVariable_django__utils__dateparse
{
    public:
        explicit PyObjectGlobalVariable_django__utils__dateparse( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__utils__dateparse, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__utils__dateparse, (PyObject *)*this->var_name );
