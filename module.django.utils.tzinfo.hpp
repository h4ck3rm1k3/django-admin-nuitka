#ifndef __django__utils__tzinfo_H__
#define __django__utils__tzinfo_H__
...
extern PyObject *_module_django__utils__tzinfo;
extern PyDictObject *_moduledict_django__utils__tzinfo;

class PyObjectGlobalVariable_django__utils__tzinfo
{
    public:
        explicit PyObjectGlobalVariable_django__utils__tzinfo( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__utils__tzinfo, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__utils__tzinfo, (PyObject *)*this->var_name );
