#ifndef __django__template__base_H__
#define __django__template__base_H__
...
extern PyObject *_module_django__template__base;
extern PyDictObject *_moduledict_django__template__base;

class PyObjectGlobalVariable_django__template__base
{
    public:
        explicit PyObjectGlobalVariable_django__template__base( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__template__base, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__template__base, (PyObject *)*this->var_name );
