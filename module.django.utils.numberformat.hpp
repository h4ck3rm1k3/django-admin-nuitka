#ifndef __django__utils__numberformat_H__
#define __django__utils__numberformat_H__
...
extern PyObject *_module_django__utils__numberformat;
extern PyDictObject *_moduledict_django__utils__numberformat;

class PyObjectGlobalVariable_django__utils__numberformat
{
    public:
        explicit PyObjectGlobalVariable_django__utils__numberformat( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__utils__numberformat, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__utils__numberformat, (PyObject *)*this->var_name );
