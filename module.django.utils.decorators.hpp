#ifndef __django__utils__decorators_H__
#define __django__utils__decorators_H__


#include <nuitka/helpers.hpp>

MOD_INIT_DECL( django__utils__decorators );

extern PyObject *_module_django__utils__decorators;
extern PyDictObject *_moduledict_django__utils__decorators;

class PyObjectGlobalVariable_django__utils__decorators
{
    public:
        explicit PyObjectGlobalVariable_django__utils__decorators( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__utils__decorators, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__utils__decorators, (PyObject *)*this->var_name );
