#ifndef __django__db__models__sql__expressions_H__
#define __django__db__models__sql__expressions_H__
...
extern PyObject *_module_django__db__models__sql__expressions;
extern PyDictObject *_moduledict_django__db__models__sql__expressions;

class PyObjectGlobalVariable_django__db__models__sql__expressions
{
    public:
        explicit PyObjectGlobalVariable_django__db__models__sql__expressions( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__db__models__sql__expressions, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__db__models__sql__expressions, (PyObject *)*this->var_name );
