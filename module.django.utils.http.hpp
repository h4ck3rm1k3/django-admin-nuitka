#ifndef __django__utils__http_H__
#define __django__utils__http_H__


#include <nuitka/helpers.hpp>

MOD_INIT_DECL( django__utils__http );

extern PyObject *_module_django__utils__http;
extern PyDictObject *_moduledict_django__utils__http;

class PyObjectGlobalVariable_django__utils__http
{
    public:
        explicit PyObjectGlobalVariable_django__utils__http( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__utils__http, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__utils__http, (PyObject *)*this->var_name );
