...
extern PyObject *_module_django;
extern PyDictObject *_moduledict_django;

class PyObjectGlobalVariable_django
{
    public:
        explicit PyObjectGlobalVariable_django( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django, (PyObject *)*this->var_name );
