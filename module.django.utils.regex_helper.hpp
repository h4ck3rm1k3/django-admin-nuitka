#ifndef __django__utils__regex_helper_H__
#define __django__utils__regex_helper_H__
...
extern PyObject *_module_django__utils__regex_helper;
extern PyDictObject *_moduledict_django__utils__regex_helper;

class PyObjectGlobalVariable_django__utils__regex_helper
{
    public:
        explicit PyObjectGlobalVariable_django__utils__regex_helper( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__utils__regex_helper, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__utils__regex_helper, (PyObject *)*this->var_name );
