#ifndef __django__utils__tree_H__
#define __django__utils__tree_H__
...
extern PyObject *_module_django__utils__tree;
extern PyDictObject *_moduledict_django__utils__tree;

class PyObjectGlobalVariable_django__utils__tree
{
    public:
        explicit PyObjectGlobalVariable_django__utils__tree( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__utils__tree, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__utils__tree, (PyObject *)*this->var_name );
