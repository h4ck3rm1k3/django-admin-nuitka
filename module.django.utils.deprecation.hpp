#ifndef __django__utils__deprecation_H__
#define __django__utils__deprecation_H__
...
extern PyObject *_module_django__utils__deprecation;
extern PyDictObject *_moduledict_django__utils__deprecation;

class PyObjectGlobalVariable_django__utils__deprecation
{
    public:
        explicit PyObjectGlobalVariable_django__utils__deprecation( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__utils__deprecation, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__utils__deprecation, (PyObject *)*this->var_name );
