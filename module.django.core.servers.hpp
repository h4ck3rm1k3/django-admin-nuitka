#ifndef __django__core__servers_H__
#define __django__core__servers_H__
...
extern PyObject *_module_django__core__servers;
extern PyDictObject *_moduledict_django__core__servers;

class PyObjectGlobalVariable_django__core__servers
{
    public:
        explicit PyObjectGlobalVariable_django__core__servers( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__core__servers, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__core__servers, (PyObject *)*this->var_name );
