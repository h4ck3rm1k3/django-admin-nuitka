#ifndef __django__core__files__temp_H__
#define __django__core__files__temp_H__
...
extern PyObject *_module_django__core__files__temp;
extern PyDictObject *_moduledict_django__core__files__temp;

class PyObjectGlobalVariable_django__core__files__temp
{
    public:
        explicit PyObjectGlobalVariable_django__core__files__temp( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__core__files__temp, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__core__files__temp, (PyObject *)*this->var_name );
