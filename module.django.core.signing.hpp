#ifndef __django__core__signing_H__
#define __django__core__signing_H__
...
extern PyObject *_module_django__core__signing;
extern PyDictObject *_moduledict_django__core__signing;

class PyObjectGlobalVariable_django__core__signing
{
    public:
        explicit PyObjectGlobalVariable_django__core__signing( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__core__signing, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__core__signing, (PyObject *)*this->var_name );
