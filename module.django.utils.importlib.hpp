#ifndef __django__utils__importlib_H__
#define __django__utils__importlib_H__
...
extern PyObject *_module_django__utils__importlib;
extern PyDictObject *_moduledict_django__utils__importlib;

class PyObjectGlobalVariable_django__utils__importlib
{
    public:
        explicit PyObjectGlobalVariable_django__utils__importlib( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__utils__importlib, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__utils__importlib, (PyObject *)*this->var_name );
