#ifndef __django__db__models__fields_H__
#define __django__db__models__fields_H__
...
extern PyObject *_module_django__db__models__fields;
extern PyDictObject *_moduledict_django__db__models__fields;

class PyObjectGlobalVariable_django__db__models__fields
{
    public:
        explicit PyObjectGlobalVariable_django__db__models__fields( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__db__models__fields, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__db__models__fields, (PyObject *)*this->var_name );
