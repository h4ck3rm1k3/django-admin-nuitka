#ifndef __django__utils__html_parser_H__
#define __django__utils__html_parser_H__
...
extern PyObject *_module_django__utils__html_parser;
extern PyDictObject *_moduledict_django__utils__html_parser;

class PyObjectGlobalVariable_django__utils__html_parser
{
    public:
        explicit PyObjectGlobalVariable_django__utils__html_parser( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__utils__html_parser, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__utils__html_parser, (PyObject *)*this->var_name );
