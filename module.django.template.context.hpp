#ifndef __django__template__context_H__
#define __django__template__context_H__


#include <nuitka/helpers.hpp>

MOD_INIT_DECL( django__template__context );

extern PyObject *_module_django__template__context;
extern PyDictObject *_moduledict_django__template__context;

class PyObjectGlobalVariable_django__template__context
{
    public:
        explicit PyObjectGlobalVariable_django__template__context( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__template__context, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__template__context, (PyObject *)*this->var_name );
