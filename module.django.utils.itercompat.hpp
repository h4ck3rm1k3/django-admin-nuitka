#ifndef __django__utils__itercompat_H__
#define __django__utils__itercompat_H__
...
extern PyObject *_module_django__utils__itercompat;
extern PyDictObject *_moduledict_django__utils__itercompat;

class PyObjectGlobalVariable_django__utils__itercompat
{
    public:
        explicit PyObjectGlobalVariable_django__utils__itercompat( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__utils__itercompat, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__utils__itercompat, (PyObject *)*this->var_name );
