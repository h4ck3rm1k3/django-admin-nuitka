#ifndef __django__utils__functional_H__
#define __django__utils__functional_H__


#include <nuitka/helpers.hpp>

MOD_INIT_DECL( django__utils__functional );

extern PyObject *_module_django__utils__functional;
extern PyDictObject *_moduledict_django__utils__functional;

class PyObjectGlobalVariable_django__utils__functional
{
    public:
        explicit PyObjectGlobalVariable_django__utils__functional( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__utils__functional, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__utils__functional, (PyObject *)*this->var_name );
