...
extern PyObject *_module_hmac;
extern PyDictObject *_moduledict_hmac;

class PyObjectGlobalVariable_hmac
{
    public:
        explicit PyObjectGlobalVariable_hmac( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_hmac, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_hmac, (PyObject *)*this->var_name );
