#ifndef __django__core__wsgi_H__
#define __django__core__wsgi_H__
...
extern PyObject *_module_django__core__wsgi;
extern PyDictObject *_moduledict_django__core__wsgi;

class PyObjectGlobalVariable_django__core__wsgi
{
    public:
        explicit PyObjectGlobalVariable_django__core__wsgi( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__core__wsgi, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__core__wsgi, (PyObject *)*this->var_name );
