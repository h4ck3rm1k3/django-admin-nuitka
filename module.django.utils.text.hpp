#ifndef __django__utils__text_H__
#define __django__utils__text_H__
...
extern PyObject *_module_django__utils__text;
extern PyDictObject *_moduledict_django__utils__text;

class PyObjectGlobalVariable_django__utils__text
{
    public:
        explicit PyObjectGlobalVariable_django__utils__text( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__utils__text, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__utils__text, (PyObject *)*this->var_name );
