...
extern PyObject *_module_hashlib;
extern PyDictObject *_moduledict_hashlib;

class PyObjectGlobalVariable_hashlib
{
    public:
        explicit PyObjectGlobalVariable_hashlib( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_hashlib, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_hashlib, (PyObject *)*this->var_name );
