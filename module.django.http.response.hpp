#ifndef __django__http__response_H__
#define __django__http__response_H__


#include <nuitka/helpers.hpp>

MOD_INIT_DECL( django__http__response );

extern PyObject *_module_django__http__response;
extern PyDictObject *_moduledict_django__http__response;

class PyObjectGlobalVariable_django__http__response
{
    public:
        explicit PyObjectGlobalVariable_django__http__response( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__http__response, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__http__response, (PyObject *)*this->var_name );
