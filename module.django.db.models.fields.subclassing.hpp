#ifndef __django__db__models__fields__subclassing_H__
#define __django__db__models__fields__subclassing_H__
...
extern PyObject *_module_django__db__models__fields__subclassing;
extern PyDictObject *_moduledict_django__db__models__fields__subclassing;

class PyObjectGlobalVariable_django__db__models__fields__subclassing
{
    public:
        explicit PyObjectGlobalVariable_django__db__models__fields__subclassing( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__db__models__fields__subclassing, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__db__models__fields__subclassing, (PyObject *)*this->var_name );
