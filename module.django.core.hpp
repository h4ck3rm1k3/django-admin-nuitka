#ifndef __django__core_H__
#define __django__core_H__
...
extern PyObject *_module_django__core;
extern PyDictObject *_moduledict_django__core;

class PyObjectGlobalVariable_django__core
{
    public:
        explicit PyObjectGlobalVariable_django__core( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__core, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__core, (PyObject *)*this->var_name );
