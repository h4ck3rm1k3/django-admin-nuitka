#ifndef __django__utils__termcolors_H__
#define __django__utils__termcolors_H__
...
extern PyObject *_module_django__utils__termcolors;
extern PyDictObject *_moduledict_django__utils__termcolors;

class PyObjectGlobalVariable_django__utils__termcolors
{
    public:
        explicit PyObjectGlobalVariable_django__utils__termcolors( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__utils__termcolors, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__utils__termcolors, (PyObject *)*this->var_name );
