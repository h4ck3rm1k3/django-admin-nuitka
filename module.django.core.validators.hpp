#ifndef __django__core__validators_H__
#define __django__core__validators_H__


#include <nuitka/helpers.hpp>

MOD_INIT_DECL( django__core__validators );

extern PyObject *_module_django__core__validators;
extern PyDictObject *_moduledict_django__core__validators;

class PyObjectGlobalVariable_django__core__validators
{
    public:
        explicit PyObjectGlobalVariable_django__core__validators( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__core__validators, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__core__validators, (PyObject *)*this->var_name );
