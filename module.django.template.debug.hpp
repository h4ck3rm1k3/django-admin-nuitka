#ifndef __django__template__debug_H__
#define __django__template__debug_H__


#include <nuitka/helpers.hpp>

MOD_INIT_DECL( django__template__debug );

extern PyObject *_module_django__template__debug;
extern PyDictObject *_moduledict_django__template__debug;

class PyObjectGlobalVariable_django__template__debug
{
    public:
        explicit PyObjectGlobalVariable_django__template__debug( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__template__debug, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__template__debug, (PyObject *)*this->var_name );
