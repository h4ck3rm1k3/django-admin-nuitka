#ifndef __django__template__loader_H__
#define __django__template__loader_H__
...
extern PyObject *_module_django__template__loader;
extern PyDictObject *_moduledict_django__template__loader;

class PyObjectGlobalVariable_django__template__loader
{
    public:
        explicit PyObjectGlobalVariable_django__template__loader( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__template__loader, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__template__loader, (PyObject *)*this->var_name );
