#ifndef __django__core__management__color_H__
#define __django__core__management__color_H__
...
extern PyObject *_module_django__core__management__color;
extern PyDictObject *_moduledict_django__core__management__color;

class PyObjectGlobalVariable_django__core__management__color
{
    public:
        explicit PyObjectGlobalVariable_django__core__management__color( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__core__management__color, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__core__management__color, (PyObject *)*this->var_name );
