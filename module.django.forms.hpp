#ifndef __django__forms_H__
#define __django__forms_H__
...
extern PyObject *_module_django__forms;
extern PyDictObject *_moduledict_django__forms;

class PyObjectGlobalVariable_django__forms
{
    public:
        explicit PyObjectGlobalVariable_django__forms( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__forms, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__forms, (PyObject *)*this->var_name );
