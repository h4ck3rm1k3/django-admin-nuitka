#ifndef __django__forms__util_H__
#define __django__forms__util_H__


#include <nuitka/helpers.hpp>

MOD_INIT_DECL( django__forms__util );

extern PyObject *_module_django__forms__util;
extern PyDictObject *_moduledict_django__forms__util;

class PyObjectGlobalVariable_django__forms__util
{
    public:
        explicit PyObjectGlobalVariable_django__forms__util( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__forms__util, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__forms__util, (PyObject *)*this->var_name );
