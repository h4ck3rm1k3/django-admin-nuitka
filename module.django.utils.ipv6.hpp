#ifndef __django__utils__ipv6_H__
#define __django__utils__ipv6_H__
...
extern PyObject *_module_django__utils__ipv6;
extern PyDictObject *_moduledict_django__utils__ipv6;

class PyObjectGlobalVariable_django__utils__ipv6
{
    public:
        explicit PyObjectGlobalVariable_django__utils__ipv6( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__utils__ipv6, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__utils__ipv6, (PyObject *)*this->var_name );
