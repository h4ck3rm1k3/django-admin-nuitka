#ifndef __django__core__files__move_H__
#define __django__core__files__move_H__
...
extern PyObject *_module_django__core__files__move;
extern PyDictObject *_moduledict_django__core__files__move;

class PyObjectGlobalVariable_django__core__files__move
{
    public:
        explicit PyObjectGlobalVariable_django__core__files__move( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__core__files__move, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__core__files__move, (PyObject *)*this->var_name );
