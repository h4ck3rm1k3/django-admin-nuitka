#ifndef __django__template_H__
#define __django__template_H__
...
extern PyObject *_module_django__template;
extern PyDictObject *_moduledict_django__template;

class PyObjectGlobalVariable_django__template
{
    public:
        explicit PyObjectGlobalVariable_django__template( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__template, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__template, (PyObject *)*this->var_name );
