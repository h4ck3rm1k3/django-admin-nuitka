#ifndef __django__http__utils_H__
#define __django__http__utils_H__
...
extern PyObject *_module_django__http__utils;
extern PyDictObject *_moduledict_django__http__utils;

class PyObjectGlobalVariable_django__http__utils
{
    public:
        explicit PyObjectGlobalVariable_django__http__utils( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__http__utils, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__http__utils, (PyObject *)*this->var_name );
