#ifndef __django__utils__formats_H__
#define __django__utils__formats_H__
...
extern PyObject *_module_django__utils__formats;
extern PyDictObject *_moduledict_django__utils__formats;

class PyObjectGlobalVariable_django__utils__formats
{
    public:
        explicit PyObjectGlobalVariable_django__utils__formats( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__utils__formats, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__utils__formats, (PyObject *)*this->var_name );
