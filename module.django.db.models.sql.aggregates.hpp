#ifndef __django__db__models__sql__aggregates_H__
#define __django__db__models__sql__aggregates_H__
...
extern PyObject *_module_django__db__models__sql__aggregates;
extern PyDictObject *_moduledict_django__db__models__sql__aggregates;

class PyObjectGlobalVariable_django__db__models__sql__aggregates
{
    public:
        explicit PyObjectGlobalVariable_django__db__models__sql__aggregates( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__db__models__sql__aggregates, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__db__models__sql__aggregates, (PyObject *)*this->var_name );
