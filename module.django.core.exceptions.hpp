#ifndef __django__core__exceptions_H__
#define __django__core__exceptions_H__


#include <nuitka/helpers.hpp>

MOD_INIT_DECL( django__core__exceptions );

extern PyObject *_module_django__core__exceptions;
extern PyDictObject *_moduledict_django__core__exceptions;

class PyObjectGlobalVariable_django__core__exceptions
{
    public:
        explicit PyObjectGlobalVariable_django__core__exceptions( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__core__exceptions, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__core__exceptions, (PyObject *)*this->var_name );
