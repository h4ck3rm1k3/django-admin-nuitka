#ifndef __django__utils__datastructures_H__
#define __django__utils__datastructures_H__


#include <nuitka/helpers.hpp>

MOD_INIT_DECL( django__utils__datastructures );

extern PyObject *_module_django__utils__datastructures;
extern PyDictObject *_moduledict_django__utils__datastructures;

class PyObjectGlobalVariable_django__utils__datastructures
{
    public:
        explicit PyObjectGlobalVariable_django__utils__datastructures( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__utils__datastructures, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__utils__datastructures, (PyObject *)*this->var_name );
