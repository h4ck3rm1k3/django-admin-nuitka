#ifndef __django__utils__safestring_H__
#define __django__utils__safestring_H__
...
extern PyObject *_module_django__utils__safestring;
extern PyDictObject *_moduledict_django__utils__safestring;

class PyObjectGlobalVariable_django__utils__safestring
{
    public:
        explicit PyObjectGlobalVariable_django__utils__safestring( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__utils__safestring, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__utils__safestring, (PyObject *)*this->var_name );
