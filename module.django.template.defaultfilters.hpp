#ifndef __django__template__defaultfilters_H__
#define __django__template__defaultfilters_H__
...
extern PyObject *_module_django__template__defaultfilters;
extern PyDictObject *_moduledict_django__template__defaultfilters;

class PyObjectGlobalVariable_django__template__defaultfilters
{
    public:
        explicit PyObjectGlobalVariable_django__template__defaultfilters( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__template__defaultfilters, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__template__defaultfilters, (PyObject *)*this->var_name );
