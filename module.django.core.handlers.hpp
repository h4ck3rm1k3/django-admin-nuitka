#ifndef __django__core__handlers_H__
#define __django__core__handlers_H__
...
extern PyObject *_module_django__core__handlers;
extern PyDictObject *_moduledict_django__core__handlers;

class PyObjectGlobalVariable_django__core__handlers
{
    public:
        explicit PyObjectGlobalVariable_django__core__handlers( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__core__handlers, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__core__handlers, (PyObject *)*this->var_name );
