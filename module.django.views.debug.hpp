#ifndef __django__views__debug_H__
#define __django__views__debug_H__
...
extern PyObject *_module_django__views__debug;
extern PyDictObject *_moduledict_django__views__debug;

class PyObjectGlobalVariable_django__views__debug
{
    public:
        explicit PyObjectGlobalVariable_django__views__debug( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__views__debug, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__views__debug, (PyObject *)*this->var_name );
