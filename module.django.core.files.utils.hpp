#ifndef __django__core__files__utils_H__
#define __django__core__files__utils_H__
...
extern PyObject *_module_django__core__files__utils;
extern PyDictObject *_moduledict_django__core__files__utils;

class PyObjectGlobalVariable_django__core__files__utils
{
    public:
        explicit PyObjectGlobalVariable_django__core__files__utils( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__core__files__utils, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__core__files__utils, (PyObject *)*this->var_name );
