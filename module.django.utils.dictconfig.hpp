#ifndef __django__utils__dictconfig_H__
#define __django__utils__dictconfig_H__


#include <nuitka/helpers.hpp>

MOD_INIT_DECL( django__utils__dictconfig );

extern PyObject *_module_django__utils__dictconfig;
extern PyDictObject *_moduledict_django__utils__dictconfig;

class PyObjectGlobalVariable_django__utils__dictconfig
{
    public:
        explicit PyObjectGlobalVariable_django__utils__dictconfig( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__utils__dictconfig, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__utils__dictconfig, (PyObject *)*this->var_name );
