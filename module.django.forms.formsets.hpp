#ifndef __django__forms__formsets_H__
#define __django__forms__formsets_H__


#include <nuitka/helpers.hpp>

MOD_INIT_DECL( django__forms__formsets );

extern PyObject *_module_django__forms__formsets;
extern PyDictObject *_moduledict_django__forms__formsets;

class PyObjectGlobalVariable_django__forms__formsets
{
    public:
        explicit PyObjectGlobalVariable_django__forms__formsets( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__forms__formsets, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__forms__formsets, (PyObject *)*this->var_name );
