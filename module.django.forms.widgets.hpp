#ifndef __django__forms__widgets_H__
#define __django__forms__widgets_H__
...
extern PyObject *_module_django__forms__widgets;
extern PyDictObject *_moduledict_django__forms__widgets;

class PyObjectGlobalVariable_django__forms__widgets
{
    public:
        explicit PyObjectGlobalVariable_django__forms__widgets( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__forms__widgets, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__forms__widgets, (PyObject *)*this->var_name );
