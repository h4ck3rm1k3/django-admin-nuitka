#ifndef __django__utils__dateformat_H__
#define __django__utils__dateformat_H__
...
extern PyObject *_module_django__utils__dateformat;
extern PyDictObject *_moduledict_django__utils__dateformat;

class PyObjectGlobalVariable_django__utils__dateformat
{
    public:
        explicit PyObjectGlobalVariable_django__utils__dateformat( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__utils__dateformat, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__utils__dateformat, (PyObject *)*this->var_name );
