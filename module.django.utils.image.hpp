#ifndef __django__utils__image_H__
#define __django__utils__image_H__
...
extern PyObject *_module_django__utils__image;
extern PyDictObject *_moduledict_django__utils__image;

class PyObjectGlobalVariable_django__utils__image
{
    public:
        explicit PyObjectGlobalVariable_django__utils__image( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__utils__image, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__utils__image, (PyObject *)*this->var_name );
