#ifndef __django__db__models__options_H__
#define __django__db__models__options_H__


#include <nuitka/helpers.hpp>

MOD_INIT_DECL( django__db__models__options );

extern PyObject *_module_django__db__models__options;
extern PyDictObject *_moduledict_django__db__models__options;

class PyObjectGlobalVariable_django__db__models__options
{
    public:
        explicit PyObjectGlobalVariable_django__db__models__options( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__db__models__options, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__db__models__options, (PyObject *)*this->var_name );
