#ifndef __django__core__files_H__
#define __django__core__files_H__


#include <nuitka/helpers.hpp>

MOD_INIT_DECL( django__core__files );

extern PyObject *_module_django__core__files;
extern PyDictObject *_moduledict_django__core__files;

class PyObjectGlobalVariable_django__core__files
{
    public:
        explicit PyObjectGlobalVariable_django__core__files( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__core__files, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__core__files, (PyObject *)*this->var_name );
