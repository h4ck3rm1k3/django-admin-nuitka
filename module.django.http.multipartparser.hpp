#ifndef __django__http__multipartparser_H__
#define __django__http__multipartparser_H__
...
extern PyObject *_module_django__http__multipartparser;
extern PyDictObject *_moduledict_django__http__multipartparser;

class PyObjectGlobalVariable_django__http__multipartparser
{
    public:
        explicit PyObjectGlobalVariable_django__http__multipartparser( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__http__multipartparser, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__http__multipartparser, (PyObject *)*this->var_name );
