#ifndef __django__core__files__base_H__
#define __django__core__files__base_H__
...
extern PyObject *_module_django__core__files__base;
extern PyDictObject *_moduledict_django__core__files__base;

class PyObjectGlobalVariable_django__core__files__base
{
    public:
        explicit PyObjectGlobalVariable_django__core__files__base( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__core__files__base, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__core__files__base, (PyObject *)*this->var_name );
