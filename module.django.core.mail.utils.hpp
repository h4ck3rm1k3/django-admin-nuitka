#ifndef __django__core__mail__utils_H__
#define __django__core__mail__utils_H__
...
extern PyObject *_module_django__core__mail__utils;
extern PyDictObject *_moduledict_django__core__mail__utils;

class PyObjectGlobalVariable_django__core__mail__utils
{
    public:
        explicit PyObjectGlobalVariable_django__core__mail__utils( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__core__mail__utils, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__core__mail__utils, (PyObject *)*this->var_name );
