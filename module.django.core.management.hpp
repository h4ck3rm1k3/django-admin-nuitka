#ifndef __django__core__management_H__
#define __django__core__management_H__


#include <nuitka/helpers.hpp>

MOD_INIT_DECL( django__core__management );

extern PyObject *_module_django__core__management;
extern PyDictObject *_moduledict_django__core__management;

class PyObjectGlobalVariable_django__core__management
{
    public:
        explicit PyObjectGlobalVariable_django__core__management( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
