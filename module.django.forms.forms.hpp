#ifndef __django__forms__forms_H__
#define __django__forms__forms_H__


#include <nuitka/helpers.hpp>

MOD_INIT_DECL( django__forms__forms );

extern PyObject *_module_django__forms__forms;
extern PyDictObject *_moduledict_django__forms__forms;

class PyObjectGlobalVariable_django__forms__forms
{
    public:
        explicit PyObjectGlobalVariable_django__forms__forms( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__forms__forms, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__forms__forms, (PyObject *)*this->var_name );
