#ifndef __django__core__files__uploadedfile_H__
#define __django__core__files__uploadedfile_H__
...
extern PyObject *_module_django__core__files__uploadedfile;
extern PyDictObject *_moduledict_django__core__files__uploadedfile;

class PyObjectGlobalVariable_django__core__files__uploadedfile
{
    public:
        explicit PyObjectGlobalVariable_django__core__files__uploadedfile( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__core__files__uploadedfile, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__core__files__uploadedfile, (PyObject *)*this->var_name );
