#ifndef __django__db__models__signals_H__
#define __django__db__models__signals_H__
...
extern PyObject *_module_django__db__models__signals;
extern PyDictObject *_moduledict_django__db__models__signals;

class PyObjectGlobalVariable_django__db__models__signals
{
    public:
        explicit PyObjectGlobalVariable_django__db__models__signals( PyObject **dummy, PyObject **var_name )
        {
            assert( var_name );
        ...
        {
            PyObject *result = GET_STRING_DICT_VALUE( _moduledict_django__db__models__signals, *this->var_name );
        ...
        {
            int status = PyDict_DelItem( (PyObject *)_moduledict_django__db__models__signals, (PyObject *)*this->var_name );
